...
<div class="main-1">
<h1>Vendas do site</h1>
@include('layouts.moderador.menuvenda')
        ...
        <section class="content">
          ...
          <div class="col-md-12 col-md-offset-2">
            ...
            @if ($registros == 0)
              ...
              <p class="text-justify col-md-offset-3 h2">Ainda não foi feita nenhuma venda no site.</p>
                          ...
                          {{csrf_field()}}
                            ...
                            <td class="text-center" style="vertical-align: middle;">
                              ...
                              <div class="media">
                                ...
                                <a data-fancybox="gallery" href="/usuario/previewLarge/{{$venda->id }}" class="pull-left"><img src="/usuario/preview/{{ $venda->id }}" class="media-photo" style="width: 100px; height: 70px;"></a>
                            ...
                            <td class="text-center" style="width: 120px; vertical-align: middle;">{{ $venda->quantidade }}</td>
