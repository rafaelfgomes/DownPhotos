...
Route::get('/relatorios/usuario','RelatoriosUsuarioController@mostrarRelatoriosForm')->name('relatoriosUsuario')->middleware('naoLogado'); 
...
Route::get('/usuario/compras', 'UsuarioController@minhasCompras')->middleware('naoLogado');
Route::get('/usuario/vendas', 'UsuarioController@minhasVendas')->middleware('naoLogado');
...
Route::get('/relatorios','RelatoriosController@mostrarRelatoriosForm')->name('relatorios')->middleware('naoLogado'); //alterado por rafael gomes
...
Route::get('/moderador/vendas', 'ModeracaoController@vendasDoSite')->middleware('naoLogado');
...
Route::post('/baixarCompradas', ['as' => 'Imagem.baixarCompradas', 'uses' => 'ImagemController@baixarCompradas'])->middleware('naoLogado');
...
Route::get('/pagamento/{id}', ['as' => 'pagamento', 'uses' => 'PagamentoController@index'])->middleware('naoLogado');
Route::post('/pagamento/criarSessao', ['as' => 'pagamento.sessao', 'uses' => 'PagamentoController@criarSessao'])->middleware('naoLogado');
Route::post('/pagamento/{id}/checkout', ['as' => 'pagamento.checkout', 'uses' => 'PagamentoController@executarCheckout'])->middleware('naoLogado');
Route::get('/notificacao', ['as' => 'notificacao.pagamento', 'uses' => 'PagamentoController@notificacao'])->middleware('naoLogado');